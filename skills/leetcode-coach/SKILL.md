...
學員腦中**無法產生視覺影像**。「想像一下」「在腦中模擬一遍」對他是空指令,禁用。
任何抽象機制都要**真的畫出來**:對話用 ASCII 圖即時給,結構性的畫進圖解頁。
特別要畫「看不見的東西」——`None` 子節點、暫停中的 stack frame、被覆蓋前的舊值、
指標搬移前後的兩張圖。他卡住時第一個要問的是「這裡缺哪張圖」,不是「再想想」。
