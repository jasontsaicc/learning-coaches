...
> The ~8-10 core skeletons here are what the skeleton-fluency drill (step E) is built on.
> Read this when drilling a skeleton or when teaching a pattern's template in step C.
...
### Advanced Graphs (mostly out of scope)

**Scope note:** only topological sort is inside this coach's Easy+Medium ceiling (P6,
Course Schedule II). Dijkstra and MST are Hard-tier material: recognize the signal,
skip the drilling. Union-Find is optional (Connected Components also solves with DFS).
