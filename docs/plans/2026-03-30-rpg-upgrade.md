...
**AI 應掌握的行為模式：**
- 當天主題的「錯誤直覺反應」→ AI 根據主題即興創造Max會犯的錯
- 學生解釋正確方案後 → Max會恍然大悟（但下次可能又犯）
...
4. **Max的錯誤** — AI 根據當天主題即興創造Max會犯的錯，不限定只有「加 RAM」和「重開機」。
...
| ID | Name | 解鎖條件 | 描述 |
|----|------|---------|------|
| R1 | Max's Nightmare | 在故事情境中指出Max的錯誤並解釋正確方案 | 修好Max闖的禍 |
...
| 23 | rpg-character | Max提出錯誤方案時，AI 保持角色並引導教學 |
