...
| 目前主題 | **P1 chunk 1-5 全 ✅**(chunk 5 = resource/QoS/OOM,C+D+E+F 全做完);下一堂 = **P1 畢業 Gate**(故障 10 分鐘內定位) |
| 上次 session 日期 | 2026-06-24 |
| session 累計次數 (session_count) | 5 |
...
> 下次繼續(一句話):跑 **P1 畢業 Gate** — 給一個混合故障場景(CrashLoopBackOff / OOM / probe / ImagePull),要他用 describe 速查表在限定回合內定位根因 + 講穿。過了就 P1 畢業、進 P2a 網路深水區(English Ramp 開始加英文短句)。phase-1 教材檔仍未建,從第一性原理教。
