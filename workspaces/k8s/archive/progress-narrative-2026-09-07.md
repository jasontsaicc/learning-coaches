# progress.md 敘事封存(2026-09-07 搬入)

<!-- 來源:progress.md lines 43-159(Phase status / Mastery / Scorecard history / Mistake Registry)。
     搬移原因:progress.md 長到 27,373 字元,每堂開場全讀;engine/PROGRESS-SCHEMA.md 第 5 節規定
     Mastery 只有 level + last-updated 兩欄,第 6 節 scorecard 六欄,第 7 節 root-cause-tag 是 short tag,
     但這三節都被寫成整段敘事,佔全檔 68%。同一個病 2026-08-19 已在 breakpoint 區發生過一次。
     本檔為逐字複本,未刪任何字;progress.md 保留 schema 欄位並連回這裡。
     冷檔,開課不讀;查某個 topic 的完整判準/歷史時才拉對應段。 -->
